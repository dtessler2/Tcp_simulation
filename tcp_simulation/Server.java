...
public class Server {
	...
	public static void main(String[] args) throws IOException {
		...
		try (
				...
				// Gives access to input stream - server reads from client - inputStream allows
			...
			do {
				...
				try {
					...
					String packetIndex;
					while ((packetIndex = in.readLine()) != null && !packetIndex.equals("-1")
							&& !packetsToResend.contains(packetIndex)) {
